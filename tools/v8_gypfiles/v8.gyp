      ...
      'conditions': [
        ...
        ['v8_target_arch=="ia32"', {
          'sources': [  ### gcmole(arch:ia32) ###
            '<(V8_ROOT)/src/codegen/ia32/assembler-ia32-inl.h',
            '<(V8_ROOT)/src/codegen/ia32/assembler-ia32.cc',
            '<(V8_ROOT)/src/codegen/ia32/assembler-ia32.h',
            '<(V8_ROOT)/src/codegen/ia32/constants-ia32.h',
            '<(V8_ROOT)/src/codegen/ia32/cpu-ia32.cc',
            '<(V8_ROOT)/src/codegen/ia32/interface-descriptors-ia32.cc',
            '<(V8_ROOT)/src/codegen/ia32/macro-assembler-ia32.cc',
            '<(V8_ROOT)/src/codegen/ia32/macro-assembler-ia32.h',
            '<(V8_ROOT)/src/codegen/ia32/register-ia32.h',
            '<(V8_ROOT)/src/codegen/ia32/sse-instr.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/ia32/deoptimizer-ia32.cc',
            '<(V8_ROOT)/src/diagnostics/ia32/disasm-ia32.cc',
            '<(V8_ROOT)/src/execution/ia32/frame-constants-ia32.cc',
            '<(V8_ROOT)/src/execution/ia32/frame-constants-ia32.h',
        ...
        ['v8_target_arch=="x64"', {
          'sources': [  ### gcmole(arch:x64) ###
            '<(V8_ROOT)/src/codegen/x64/assembler-x64-inl.h',
            '<(V8_ROOT)/src/codegen/x64/assembler-x64.cc',
            '<(V8_ROOT)/src/codegen/x64/assembler-x64.h',
            '<(V8_ROOT)/src/codegen/x64/constants-x64.h',
            '<(V8_ROOT)/src/codegen/x64/cpu-x64.cc',
            '<(V8_ROOT)/src/codegen/x64/interface-descriptors-x64.cc',
            '<(V8_ROOT)/src/codegen/x64/macro-assembler-x64.cc',
            '<(V8_ROOT)/src/codegen/x64/macro-assembler-x64.h',
            '<(V8_ROOT)/src/codegen/x64/register-x64.h',
            '<(V8_ROOT)/src/codegen/x64/sse-instr.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/x64/deoptimizer-x64.cc',
            '<(V8_ROOT)/src/diagnostics/x64/disasm-x64.cc',
            '<(V8_ROOT)/src/diagnostics/x64/eh-frame-x64.cc',
            '<(V8_ROOT)/src/execution/x64/frame-constants-x64.cc',
            '<(V8_ROOT)/src/execution/x64/frame-constants-x64.h',
        ...
        ['v8_target_arch=="arm"', {
          'sources': [  ### gcmole(arch:arm) ###
            '<(V8_ROOT)/src/codegen/arm/assembler-arm-inl.h',
            '<(V8_ROOT)/src/codegen/arm/assembler-arm.cc',
            '<(V8_ROOT)/src/codegen/arm/assembler-arm.h',
            '<(V8_ROOT)/src/codegen/arm/constants-arm.h',
            '<(V8_ROOT)/src/codegen/arm/constants-arm.cc',
            '<(V8_ROOT)/src/codegen/arm/cpu-arm.cc',
            '<(V8_ROOT)/src/codegen/arm/interface-descriptors-arm.cc',
            '<(V8_ROOT)/src/codegen/arm/macro-assembler-arm.cc',
            '<(V8_ROOT)/src/codegen/arm/macro-assembler-arm.h',
            '<(V8_ROOT)/src/codegen/arm/register-arm.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/arm/deoptimizer-arm.cc',
            '<(V8_ROOT)/src/diagnostics/arm/disasm-arm.cc',
            '<(V8_ROOT)/src/diagnostics/arm/eh-frame-arm.cc',
            '<(V8_ROOT)/src/execution/arm/frame-constants-arm.cc',
            '<(V8_ROOT)/src/execution/arm/frame-constants-arm.h',
            '<(V8_ROOT)/src/execution/arm/simulator-arm.cc',
            '<(V8_ROOT)/src/execution/arm/simulator-arm.h',
        ...
        ['v8_target_arch=="arm64"', {
          'sources': [  ### gcmole(arch:arm64) ###
            '<(V8_ROOT)/src/codegen/arm64/assembler-arm64-inl.h',
            '<(V8_ROOT)/src/codegen/arm64/assembler-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/assembler-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/constants-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/cpu-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/decoder-arm64-inl.h',
            '<(V8_ROOT)/src/codegen/arm64/decoder-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/decoder-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/instructions-arm64-constants.cc',
            '<(V8_ROOT)/src/codegen/arm64/instructions-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/instructions-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/instrument-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/instrument-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/interface-descriptors-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/macro-assembler-arm64-inl.h',
            '<(V8_ROOT)/src/codegen/arm64/macro-assembler-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/macro-assembler-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/register-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/register-arm64.h',
            '<(V8_ROOT)/src/codegen/arm64/utils-arm64.cc',
            '<(V8_ROOT)/src/codegen/arm64/utils-arm64.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/arm64/deoptimizer-arm64.cc',
            '<(V8_ROOT)/src/diagnostics/arm64/disasm-arm64.cc',
            '<(V8_ROOT)/src/diagnostics/arm64/disasm-arm64.h',
            '<(V8_ROOT)/src/diagnostics/arm64/eh-frame-arm64.cc',
            '<(V8_ROOT)/src/execution/arm64/frame-constants-arm64.cc',
            '<(V8_ROOT)/src/execution/arm64/frame-constants-arm64.h',
            '<(V8_ROOT)/src/execution/arm64/simulator-arm64.cc',
            '<(V8_ROOT)/src/execution/arm64/simulator-arm64.h',
            '<(V8_ROOT)/src/execution/arm64/simulator-logic-arm64.cc',
        ...
        ['v8_target_arch=="mips" or v8_target_arch=="mipsel"', {
          'sources': [  ### gcmole(arch:mipsel) ###
            '<(V8_ROOT)/src/codegen/mips/assembler-mips-inl.h',
            '<(V8_ROOT)/src/codegen/mips/assembler-mips.cc',
            '<(V8_ROOT)/src/codegen/mips/assembler-mips.h',
            '<(V8_ROOT)/src/codegen/mips/constants-mips.cc',
            '<(V8_ROOT)/src/codegen/mips/constants-mips.h',
            '<(V8_ROOT)/src/codegen/mips/cpu-mips.cc',
            '<(V8_ROOT)/src/codegen/mips/interface-descriptors-mips.cc',
            '<(V8_ROOT)/src/codegen/mips/macro-assembler-mips.cc',
            '<(V8_ROOT)/src/codegen/mips/macro-assembler-mips.h',
            '<(V8_ROOT)/src/codegen/mips/register-mips.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/mips/deoptimizer-mips.cc',
            '<(V8_ROOT)/src/diagnostics/mips/disasm-mips.cc',
            '<(V8_ROOT)/src/execution/mips/frame-constants-mips.cc',
            '<(V8_ROOT)/src/execution/mips/frame-constants-mips.h',
            '<(V8_ROOT)/src/execution/mips/simulator-mips.cc',
            '<(V8_ROOT)/src/execution/mips/simulator-mips.h',
        ...
        ['v8_target_arch=="mips64" or v8_target_arch=="mips64el"', {
          'sources': [  ### gcmole(arch:mips64el) ###
            '<(V8_ROOT)/src/codegen/mips64/assembler-mips64-inl.h',
            '<(V8_ROOT)/src/codegen/mips64/assembler-mips64.cc',
            '<(V8_ROOT)/src/codegen/mips64/assembler-mips64.h',
            '<(V8_ROOT)/src/codegen/mips64/constants-mips64.cc',
            '<(V8_ROOT)/src/codegen/mips64/constants-mips64.h',
            '<(V8_ROOT)/src/codegen/mips64/cpu-mips64.cc',
            '<(V8_ROOT)/src/codegen/mips64/interface-descriptors-mips64.cc',
            '<(V8_ROOT)/src/codegen/mips64/macro-assembler-mips64.cc',
            '<(V8_ROOT)/src/codegen/mips64/macro-assembler-mips64.h',
            '<(V8_ROOT)/src/codegen/mips64/register-mips64.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/mips64/deoptimizer-mips64.cc',
            '<(V8_ROOT)/src/diagnostics/mips64/disasm-mips64.cc',
            '<(V8_ROOT)/src/execution/mips64/frame-constants-mips64.cc',
            '<(V8_ROOT)/src/execution/mips64/frame-constants-mips64.h',
            '<(V8_ROOT)/src/execution/mips64/simulator-mips64.cc',
            '<(V8_ROOT)/src/execution/mips64/simulator-mips64.h',
        ...
        ['v8_target_arch=="ppc" or v8_target_arch=="ppc64"', {
          'sources': [  ### gcmole(arch:ppc) ###
            '<(V8_ROOT)/src/codegen/ppc/assembler-ppc-inl.h',
            '<(V8_ROOT)/src/codegen/ppc/assembler-ppc.cc',
            '<(V8_ROOT)/src/codegen/ppc/assembler-ppc.h',
            '<(V8_ROOT)/src/codegen/ppc/constants-ppc.h',
            '<(V8_ROOT)/src/codegen/ppc/constants-ppc.cc',
            '<(V8_ROOT)/src/codegen/ppc/cpu-ppc.cc',
            '<(V8_ROOT)/src/codegen/ppc/interface-descriptors-ppc.cc',
            '<(V8_ROOT)/src/codegen/ppc/macro-assembler-ppc.cc',
            '<(V8_ROOT)/src/codegen/ppc/macro-assembler-ppc.h',
            '<(V8_ROOT)/src/codegen/ppc/register-ppc.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/ppc/deoptimizer-ppc.cc',
            '<(V8_ROOT)/src/diagnostics/ppc/disasm-ppc.cc',
            '<(V8_ROOT)/src/execution/ppc/frame-constants-ppc.cc',
            '<(V8_ROOT)/src/execution/ppc/frame-constants-ppc.h',
            '<(V8_ROOT)/src/execution/ppc/simulator-ppc.cc',
            '<(V8_ROOT)/src/execution/ppc/simulator-ppc.h',
        ...
        ['v8_target_arch=="s390" or v8_target_arch=="s390x"', {
          'sources': [  ### gcmole(arch:s390) ###
            '<(V8_ROOT)/src/codegen/s390/assembler-s390-inl.h',
            '<(V8_ROOT)/src/codegen/s390/assembler-s390.cc',
            '<(V8_ROOT)/src/codegen/s390/assembler-s390.h',
            '<(V8_ROOT)/src/codegen/s390/constants-s390.cc',
            '<(V8_ROOT)/src/codegen/s390/constants-s390.h',
            '<(V8_ROOT)/src/codegen/s390/cpu-s390.cc',
            '<(V8_ROOT)/src/codegen/s390/interface-descriptors-s390.cc',
            '<(V8_ROOT)/src/codegen/s390/macro-assembler-s390.cc',
            '<(V8_ROOT)/src/codegen/s390/macro-assembler-s390.h',
            '<(V8_ROOT)/src/codegen/s390/register-s390.h',
            ...
            '<(V8_ROOT)/src/deoptimizer/s390/deoptimizer-s390.cc',
            '<(V8_ROOT)/src/diagnostics/s390/disasm-s390.cc',
            '<(V8_ROOT)/src/execution/s390/frame-constants-s390.cc',
            '<(V8_ROOT)/src/execution/s390/frame-constants-s390.h',
            '<(V8_ROOT)/src/execution/s390/simulator-s390.cc',
            '<(V8_ROOT)/src/execution/s390/simulator-s390.h',
